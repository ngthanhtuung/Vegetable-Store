...
public class SendEmail {
    ...
    public boolean sendEmail(UserEmailDTO user) throws MessagingException {
        ...
        String myAccountEmail = "vegetablestore2022@gmail.com";
        String password = "tungntse151167@";
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, UserEmailDTO user) {
        try {
            ...
            message.setFrom(new InternetAddress(myAccountEmail, "Vegetable Store"));
            ...
            String mess = "<!DOCTYPE html>\n"
                    ...
                    + "            <p>Thank you for choosing Vegetable Store. Use the following OTP to complete your Sign Up procedures.</p>\n"
                    + "            <h2\n"
                    ...
                    + "                <p>Vegetable Store Inc</p>\n"
                    + "                <p>tungntse151167@fpt.edu.vn</p>\n"
                    + "                <p>+84 868 649 875</p>\n"
                    + "            </div>\n"
                    + "        </div>\n"
                    + "    </div>\n"
