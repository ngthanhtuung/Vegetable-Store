...
public class SendOTPController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO user = (UserDTO) request.getAttribute("USER_VERIFY");
            ...
            UserEmailDTO userEmail = new UserEmailDTO(email, fullName, password, roleID, address, birthday, phone, code);
            boolean check = se.sendEmail(userEmail);
            if (check) {
            ...
            log("Error at UserVerifyController: " + e.toString());
        } finally {
